...
$email_body = "<a href='http://www.ionexhibits.com/KCCL_dev/K".$ordernumber.".pdf'>DeVry Order Number: K".$ordernumber."</a>";

ini_set("SMTP","172.20.10.253");
if(mail("DevryOnlineOrder@ionexhibits.com, kam@ionexhibits.com, dcs@ionexhibits.com", "KCCL web order",$email_body."<br>".$ip, $headers)){
...
<a href="#" id="printer" style="float:right;position:relative;">print</a><a href="./K<?php echo $ordernumber; ?>.pdf" id="pdf_button" style="float:right;position:relative;">download pdf</a><br>
</div>
<hr>
<?php
echo $body;
