...
<script type="text/javascript">
function contact(){
		alert("Please contact Kim Gillette with ion exhibits\n" +
      		" at 630-227-4561 or by email\n" +
      		" kag@ionexhibits.com\n" +
          " Mary Levi at 630-227-4564 or by email\n" +
          " mel@ionexhibits.com")
	}
</script>
...
for($i=0;$i<count($detail_array);$i++){
			...
			echo("<tr>\n<td width=\"20%\">\n");
			echo("<center>\n<table>\n<tr>\n<td>\n<a href='$headeritem/details/main.jpg'>\n<img src=\"$headeritem/details/main.jpg\" height=\"168\"></a>\n");
			echo("</td>\n</tr>\n");
			echo("<tr>\n<td>\n");
			...
			echo("<input type=\"hidden\" name=\"$clean.$plus.\" id=\"$setter\" value=\"0\">\n");			
			

			echo("</td>\n</tr>\n");
			
                        if (file_exists("./$headeritem/details/setup.txt")) {
			echo("<tr>\n<td>\n");
			$setup = file_get_contents("./$headeritem/details/setup.txt"); 
			$sdollar = number_format($setup);
			$scleandollar = str_replace(",","",$sdollar);
                        echo("<font size=\"3px\"><b>Set-up cost for first solution</b></font><br>");
			echo "$",$sdollar,"*";
                        echo("</td>\n</tr>\n");
			}
