            ...
            // Its a directory, so we need to keep reading down... 
                ...
                // Open the directory to the handle $dh 
                  ...
                  // Loop through the directory
                    ...
                    echo "<p id=\"".$frep."xx".$sprp."\" style=\"cursor:pointer;padding-left: 15px;font-size:11px;background:url(./assets/images/bg-nav-level1.gif) repeat-x 0 -17px;margin:0px 0px 0px 0px;border:solid 1px #cccccc\">".$ele."</p>";
                ...
                // Open the directory to the handle $dh 
                  ...
                  // Loop through the directory
                    ...
                    $frep = str_replace(" ","_", $file);
                     ...
                     echo("$(document).ready(function(){\n$(\"#".$frep."xx".$sprp."\").click(function(){\n$(\"#main_container\").load(\"item.php\", {theunit: '".$frep."xx".$sprp."xx".$path."'});\n});\n});\n");
                    }
                    else
                    {
                    //echo "not a directory - $path/$ele<br>";
...
$("#devry_menu").attr("style","display:inline;width:140px;float:left;");
$("#kccl_menu").attr("style","display:none");

}
else
{
$("#kccl_menu").attr("style","display:inline;width:140px;float:left;");
$("#devry_menu").attr("style","display:none");
...
<div class="accord" id="devry_menu" style="width:140px;display:none;float:left;">			
<?php
getDirectory( "schools/devry" ); 
?>
</div>

<div class="accord" id="kccl_menu" style="width:140px;display:none;float:left;">			
<?php
...
<div id="main_container" style="height:600px">
  <div id="title">
	...
	<div id="content_container">
	  ...
	  <div>
	  <a href="#" style="position:relative;display:inline;padding-right:10px;z-index:1000" onclick="flipper('devry_menu');"><img src="./assets/images/devry_select_button.png"></a>
	  <a href="#" style="position:relative;display:inline:10px;z-index:1000" onclick="flipper('kccl_menu');"><img src="./assets/images/keller_select_button.png"></a>
	  </div>
